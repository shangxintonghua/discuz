...
<head>
    ...
    .revcontent .comment_list li .comment_con_wrapper .con {
    color: #fff;
    }
    .revcontent .comment_list li .comment_con_wrapper .reply_wrap{
    background: rgba(0,0,0,0.2);
    color: #fff;
    }
    .revcontent .comment_list li .commnet_op .reply {
    color: #fff;
    }
    .revcontent{
    border:none;
        ...
        <div class="tab_pl act">
			<div class="review_grade_wrap">
				...
				<form id="form" name="form" action="" method="get">
					<div style="margin:10px 0px 0px 10px; color:#FFFFFF;">
                    <?php 
					if($Example_uid){ 
