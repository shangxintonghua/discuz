...
document.cookie = name + "=" + escape (value) +
        ...
        $(document).ready(function(){
            ...
            if(skey==""){
				...
				$("#result").html('<a href="#0"  target="_blank" id="form-btn" data-show-layer="hw-layer-login" role="button"><i class="hd_pic"><img src="http://static.modiauto.com.cn/png/201702/7ec86ccb-cc7d-44d0-a2e0-9148f2c335d3.png" alt=""></i><span class="nickname">登录</span></a>');
