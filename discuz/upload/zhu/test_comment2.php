        ...
        <div class="tab_pl act">
			<div class="review_grade_wrap">
				...
				<form id="form" name="form" action="" method="get">
                    ...
                    <?php }else{?>
                    	<a href="http://id.modiauto.com.cn" target="_blank">登录</a> | <a href="http://bbs.modiauto.com.cn/member.php?mod=register" target="_blank">注册无敌通信证</a>
                    <?php }?>
                    </div>
                    <br class="clear_f">
					<?php
                    ...
                    <div class="Input_Box">
                        ...
                        <textarea class="review_text" name="content1" rows="10" placeholder="无敌网温馨提示您：留言中请不要恶意攻击国家、地区、车型、车主、用户及无敌网小编，不要发布任何广告性质内容。一经发现，我们将会采取响应处理惩罚。请珍惜保护无敌网的车友交流环境。"><?php 
													echo $_POST[content1];
...
<?php }else{?>
    <a type="submit" style="padding: 5px;border: medium none;background:#5C5858; font-size: 18px;height: 35px;line-height: 33px;border-radius: 2px;color: #fff;cursor: pointer;" class="" href="http://id.modiauto.com.cn">请先登录</a>
